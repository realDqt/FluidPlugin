...
public:
    ...
    /**
     * @brief Get the length of a cell.
     *
    ...
    /**
     * @brief Calculate the lifetime of smoke.
     * 
     * @return True if the lifetime is greater than the maximum life, False otherwise.
     */
...
public:
    ...
    uint getCellNum() { return m_numCells; }
protected: 
    // CPU data
