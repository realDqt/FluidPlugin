...
public:
   ...
   * @param c Translation from Vector default (0,0,0)*/
		  ...
		  m_pos(c)
	{
 	...
 	/**
	 * Constructs a new Transform object by copying the values from another Transform object.
	 *
	 * @param other The Transform object to copy from.
	 *
	 * @return A new Transform object with the same rotation and position as the other Transform object.
	 *
	 * @throws None
	 */
