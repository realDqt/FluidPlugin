...
public:
	...
	*/
				...
				const Real& zx, const Real& zy, const Real& zz)
	{
		...
		/**
	 * Constructor for creating a Matrix3x3 object from another Matrix3x3 object.
	 *
	 * @param other The Matrix3x3 object to copy from.
	 */
	...
	FORCE_INLINE Matrix3x3& operator=(const Matrix3x3& other)
	{
	    ...
	    /**
     * Constructs a Matrix3x3 object with the given Vector3 objects.
     *
     * @param v0 The first Vector3 object.
     * @param v1 The second Vector3 object.
     * @param v2 The third Vector3 object.
     *
	 ...
	 *
	 * @param i the index of the column vector
	 *
	 * @return the column vector at index i
	 */
	...
	* Equivilant to this = this - m */
	...
	/**
	 * Set the values of the matrix from an OpenGL sub-matrix.
	 *
	 * @param m pointer to the OpenGL sub-matrix
	 *
	 * @throws ErrorType description of error
	 */ 
	...
	**/
    ...
    /**
     * Sets all values of the object to zero.
     *
     * This function sets all values of the object to zero by calling the
     * setValue() function with zero for all arguments.
     *
     * @throws ErrorType description of error
     */ 
    void setZero()
	...
	static const Matrix3x3& Zero()
	{
 	...
 	/**
	 * Copies the elements of the matrix to the given OpenGL sub-matrix.
	 *
	 * @param m the array representing the OpenGL sub-matrix
	 *
	 * @throws None
	 */
	...
	* @param solution_number Which solution of two possible solutions ( 1 or 2) are possible values*/
	...
	/**
	 * Calculates the dot product between this matrix and a Vector3 object.
	 *
	 * @param v The Vector3 object to calculate the dot product with.
	 *
	...
	FORCE_INLINE Real tdotx(const Vector3& v) const
	{
		...
		/**
	 * Returns the dot product of the y-components of this matrix and a given vector.
	 *
	 * @param v the vector to calculate the dot product with
	 *
	 * @return the dot product of the y-components of this matrix and the given vector
	 */
	FORCE_INLINE Real tdoty(const Vector3& v) const
	{
		...
		/**
	 * Calculates the dot product of the z-components of a Vector3 with the z-components of this Matrix3x3.
	 *
	 * @param v The Vector3 whose z-components will be used in the calculation.
	 *
	 * @return The dot product of the z-components of the Vector3 and the Matrix3x3.
	 *
	 * @throws None
	 */
...
/**
 * Multiply a Matrix3x3 object by a scalar.
 *
 * @param m the Matrix3x3 object to be multiplied
 * @param k the scalar to multiply the Matrix3x3 object by
 *
 * @return a new Matrix3x3 object resulting from the multiplication
 *
 * @throws ErrorType if an error occurs during the multiplication
 */
FORCE_INLINE Matrix3x3
...
/**
 * Adds two Matrix3x3 objects together.
 *
 * @param m1 The first Matrix3x3 object.
 * @param m2 The second Matrix3x3 object.
 *
 * @return A new Matrix3x3 object that is the sum of the two input matrices.
 *
 * @throws ErrorType The error that can occur during the addition operation.
 */
FORCE_INLINE Matrix3x3
...
/**
 * Subtracts two Matrix3x3 objects.
 *
 * @param m1 The first Matrix3x3 object.
 * @param m2 The second Matrix3x3 object.
 *
 * @return A Matrix3x3 object that is the result of subtracting m2 from m1.
 *
...
/**
 * Computes the absolute value of a 3x3 matrix.
 *
 ...
 *
 * @return The adjoint of the matrix as a new Matrix3x3 object.
 */
FORCE_INLINE Matrix3x3
Matrix3x3::adjoint() const
{
 ...
 *
 * @throws ErrorType If the determinant of the matrix is zero.
 */
FORCE_INLINE Matrix3x3
Matrix3x3::inverse() const
{
...
/**
 * Transposes the matrix and multiplies it with another matrix.
 *
 * @param m The matrix to be multiplied with.
 * 
 * @return The resulting transposed and multiplied matrix.
 *
 * @throws None
 */
FORCE_INLINE Matrix3x3
...
/**
 * Multiplies this matrix by the transpose of another matrix and returns the result.
 *
...
/**
 * Multiplies a Vector3 by a Matrix3x3.
 *
 * @param v The Vector3 to multiply.
 * @param m The Matrix3x3 to multiply.
 *
 * @return The result of multiplying the Vector3 by the Matrix3x3.
 *
 * @throws None.
 */
FORCE_INLINE Vector3
...
/**
 * Multiplies two Matrix3x3 objects and returns the result.
 *
 * @param m1 The first Matrix3x3 object to be multiplied.
 * @param m2 The second Matrix3x3 object to be multiplied.
 *
 * @return The resulting Matrix3x3 object after multiplication.
 *
 * @throws None
 */
FORCE_INLINE Matrix3x3
 ...
 * 
 * This function tests if all elements of two matrices are equal.
 * 
...
/**
 * Serializes the Matrix3x3 object into a Matrix3x3Data structure.
 *
 * @param dataOut The Matrix3x3Data structure to serialize the object into.
 *
 * @throws None
 */
...
/**
 * Serializes a Matrix3x3 object into a Matrix3x3FloatData object.
 *
 * @param dataOut The Matrix3x3FloatData object to serialize into.
 *
 * @return void
 *
 * @throws None
...
/**
 * Deserialize the Matrix3x3 using the provided data.
 *
 * @param dataIn the data to deserialize the Matrix3x3 from
 *
 * @throws ErrorType a description of the error that may occur during deserialization
 */
...
/**
 * Deserializes the given `Matrix3x3FloatData` into the current `Matrix3x3` object.
 *
 * @param dataIn The input `Matrix3x3FloatData` object to be deserialized.
 *
 * @throws ErrorType If an error occurs during deserialization.
 */
...
/**
 * Deserializes a Matrix3x3 object from a Matrix3x3DoubleData object.
 *
 * @param dataIn The Matrix3x3DoubleData object to deserialize from.
 *
 * @throws ErrorType If an error occurs during deserialization.
 */
