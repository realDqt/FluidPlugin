...
/**
 * @brief This file provides real number
 */
//// real number
...
////double
	 ...
	 *
	 * @param x the value to calculate the arc cosine of
	 *
	...
	{
		// Clamp the value within the range of -1 to 1
		if (x < Real(-1))
			x = Real(-1);
		if (x > Real(1))
			x = Real(1);
...
//// float
	 ...
	 *
	 * @param x the value for which to calculate the arccosine
	 *
	 * @return the arccosine of the given value
	 *
	 * @throws ErrorType if the value is less than -1 or greater than 1
	 */
	FORCE_INLINE Real acosr(Real x)
	{
		// Clamp the value within the range of -1 to 1
	 ...
	 *
	 * @param x the number for which to calculate the inverse sine
	 *
	 * @return the inverse sine of the input number
	 *
	 * @throws None
	 */
	FORCE_INLINE Real asinr(Real x)
