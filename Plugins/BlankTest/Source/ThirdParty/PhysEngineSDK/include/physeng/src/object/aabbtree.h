...
private:
    ...
    struct Bounds
    {
        ...
        /**
         * @brief Calculate and return the volume of the object.
         *
        ...
        inline float GetVolume() const
        {
            ...
            // Calculate the volume using the dimensions
            return (e.x*e.y*e.z);
        }

        /**
         * @brief Calculates the surface area of the object.
         *
        ...
        inline float GetSurfaceArea() const
        {
            ...
            // Calculate the surface area using the differences
            return 2.0f*(e.x*e.y + e.x*e.z + e.y*e.z);
        }
        
        /**
         * @brief Union of the current Bounds object with another Bounds object.
         *
         * @param b The Bounds object to union with.
         */
